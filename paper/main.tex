...
only through the 64-d bottleneck. The prior's goal source is the experimental factor
(\S\ref{sec:exp}): the robot-space reference $g_t$ (the actor-side bottleneck), the
