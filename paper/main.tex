...
\foreach \y/\lab/\v/\c in {0/{no goal}/0.001/corange, -5/{$z_{\mathrm{ret}}$ only}/0.656/cgreen!70!black, -10/{clock control}/0.754/corange!70!black, -15/{ours (explicit)}/0.955/cgreen, -20/{teacher}/0.954/cblue}{
...
1{,}024 rollouts per evaluation): the learned code with the explicit goal \emph{matches}
its teacher (0.955 vs 0.954); the frozen human-side retargeting latent alone reaches
0.656---but a phase-only clock control reaches 0.754, capping what the latent can claim
on a single cyclic clip.}
\label{fig:teaser}
\end{figure*}
