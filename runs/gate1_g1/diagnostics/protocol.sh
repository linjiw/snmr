...
ANALYZER="$MAIN/scripts/analyze_gate1_diagnostics.py"
...
cp "$ANALYZER" "$OUT_ROOT/analyze_gate1_diagnostics.py"
...
run_arm c0_seed0
run_arm c1_bce_seed0 --contact_bce_weight 1.0
run_arm c2_edge_seed0 --contact_bce_weight 1.0 --edge_velocity_weight 0.03
